...
const LaFirma = () => {
  ...
  return (
    <section className="bg-black pb-10 overflow-hidden" style={{ backgroundColor: "#161616ff", marginBottom: "-1px" }}>
      {/* Imagen de fondo con título */}
      <div
        className="h-72 bg-cover bg-center flex flex-col justify-center items-center text-white mb-10 w-full"
        style={{
      ...
      >
        <h1 className="text-3xl sm:text-4xl font-bold px-4 text-center" data-aos="zoom-in">¿Quienes Somos?</h1>
      </div>
      {/* Texto institucional */}
      <div className="py-8 max-w-4xl mx-auto font-bona text-white space-y-8 px-4 sm:px-6 md:px-8 w-full">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6" data-aos="zoom-out-up">RG&G Bureau Legal</h2>
        <p className="font-mona text-base sm:text-lg md:text-xl text-justify" data-aos="zoom-out-up">
        ...
        <p className="font-mona text-base sm:text-lg md:text-xl" data-aos="zoom-out-up">
        ...
        <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold mt-10 mb-4" data-aos="zoom-out-up">Quiénes Somos</h3>
        <p className="font-mona text-base sm:text-lg md:text-xl" data-aos="zoom-out-up">
