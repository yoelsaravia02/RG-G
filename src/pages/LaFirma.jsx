  ...
  return (
    <section className="bg-black overflow-hidden" style={{ backgroundColor: "#161616ff", marginBottom: "-1px" }}>
      ...
      <div className="w-full mb-16 px-[30px] md:px-[60px] lg:px-[100px] lg:ml-[170px]">
        ...
        {/* GRID CONTAINER - ver vieja -> gridTemplateColumns: isMobileLayout ? "1fr" : "1fr 1fr"*/} 
        <div 
          className="grid gap-8 lg:gap-12 items-start max-w-6xl pb-6" 
          style={{
            display: "grid",
            gridTemplateColumns: isMobileLayout ? "1fr" : "1fr", 
        ...
        >
          ...
          {/* 1. Texto Superior */}
          <div className="font-bona text-white space-y-6" data-aos="fade-right" style={{ gridColumn: isMobileLayout ? "auto" : "span 2" }}>
            ...
            <p className="font-mona text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed">
              En RG Bureau Legal, la práctica del Derecho es concebida como una disciplina de precisión, orientada a preservar intereses legítimos y facilitar decisiones fundadas en un marco de seguridad jurídica.
            </p>
          </div>
          ...
          >
            ...
            <p className="font-mona text-sm sm:text-base md:text-lg lg:text-xl text-justify leading-relaxed">
              RG Bureau Legal es una firma fundada por Santino Righetti Sagrera y Santiago Gandione, abogados egresados de la Facultad de Derecho de la Universidad Nacional de Córdoba, institución de reconocida trayectoria en la formación de abogados en la República Argentina.
            </p>

            <p className="font-mona text-sm sm:text-base md:text-lg lg:text-xl text-justify leading-relaxed">
              La dupla ha iniciado su carrera en el ámbito del ejercicio privado del Derecho, donde adquirieron una sólida experiencia en diversas ramas del ordenamiento jurídico.
            </p>

            <p className="font-mona text-sm sm:text-base md:text-lg lg:text-xl text-justify leading-relaxed">
              La filosofía de RG Bureau Legal se sustenta en la combinación de conocimiento técnico riguroso, análisis jurídico preciso y una permanente vocación de servicio. Asumimos cada asunto encomendado con absoluta dedicación, estricta confidencialidad y un profundo respeto por los principios éticos que rigen la profesión.
            </p>

            <p className="font-mona text-sm sm:text-base md:text-lg lg:text-xl text-justify leading-relaxed">
              En RG Bureau Legal, concebimos el Derecho como una herramienta de orden, previsión y resguardo, puesta al servicio de quienes requieren respaldo jurídico con seriedad, solvencia y responsabilidad.
            </p>
          </div>
