    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="bg-white text-black cursor-pointer hover:bg-gray-500 hover:text-white font-bold py-3 px-8 rounded-lg transition uppercase text-xl tracking-wide font-mona"
        >
          QUIERO UNA CITA
        </button>
      </div>
